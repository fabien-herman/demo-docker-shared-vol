    ...
    <#list thisItem.prices as thisPrice>
      <#if thisPrice.priceModifications??>
        <#list thisPrice.priceModifications as thisPriceModification>
          ...
          <#assign orderLevelPromotion = "false" />
          <#if thisPriceModification.orderLevelPromotion?? && thisPriceModification.orderLevelPromotion == true >
            <#assign orderLevelPromotion = "true" />
            </#if>
          <#if orderLevelPromotion == "false" >
            <#assign priceModificationId = thisPriceModification.id />
            <#assign customerMessage = "" />
            <#if thisPriceModification.customerMessage?? >
               <#assign customerMessage = thisPriceModification.customerMessage />
            </#if>            
               
            <#assign priceModificationDetails = { "id": priceModificationId, "count": 1, "description": customerMessage, "amount": thisPriceModification.value, "combinations": [] } />
